    ...
    >
      ...
      <div className="flex flex-wrap justify-center items-center gap-6 text-left">
        {plans.map((item, index) => (
          <div
            key={index}
            className="bg-blue-100 drop-shadow-md border cursor-pointer rounded-lg py-12
