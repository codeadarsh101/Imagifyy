...
const Header = () => {
  ...
  return (
    ...
    >
      <motion.div
        className="text-stone-500 inline-flex
            text-center gap-2 bg-white px-6 py-1 rounded-full border
            border-neutral-500"
      ...
      <motion.h1 className="text-2xl max-w-[300px] sm:text-7xl sm:max-w-[590px]
        ...
        >Unleash your creativity with AI.Turn your
            imagination into visuals art in seconds-just type,
            and watch the magic happen.
        </motion.p>

        <motion.button onClick={onClickHandler} className="sm:text-lg text-white bg-black w-auto
      ...
      <motion.div className="flex flex-wrap justify-center mt-9 gap-3"
      ...
      >
        {Array(6).fill().map((item,index)=>(
           ...
           className="rounded hover:scale-90 transition-all duration-300
