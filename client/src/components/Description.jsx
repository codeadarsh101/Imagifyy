    ...
    >
      ...
      <div className="flex flex-col md:flex-row items-center gap-10">
        <img
          ...
          className="w-40 lg:w-80 rounded-lg"
        />
        ...
        <div >
          ...
          <p className="text-gray-600 mb-4">
            Easily bring your ideas to life with our AI image generator. Our
            tool transforms your text into eye-catching images with just a few
            clicks. Imagine it, describe it, and watch the visuals instantly...
          </p>
